...
# ── Holdings + International + Ecosystem endpoints ── MOVED to
#    app/routers/holdings.py (A5.8) ────────────────────────────────────────


# ── Connector endpoints ── MOVED to app/routers/connectors.py (A5.10) ──────


# market/sources + market/backtest endpoint'leri yukarıdaki blokla birlikte
# app/routers/market.py'a taşındı (A5.9).
