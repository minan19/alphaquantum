...
# ── S-342 Financial Instruments ── MOVED to financial_instruments.py (A5.12) ──
# ── S-334 Notifications + S-343 Delivery ── MOVED to notifications.py (A5.12) ─
...
# ── Market + Global intel + Public institutions endpoints ── MOVED to
#    app/routers/market.py (A5.9) ─────────────────────────────────────────────


# ── Procurement + Feasibility + Tender endpoints ── MOVED to
#    app/routers/procurement.py (A5.11) ──────────────────────────────────────


# ── Holdings + International + Ecosystem ── MOVED to holdings.py (A5.8) ────
# ── Connectors ── MOVED to connectors.py (A5.10) ───────────────────────────
# ── Market/global/public_intel ── MOVED to market.py (A5.9) ────────────────
...
# _parse_symbols_csv helper'ı app/routers/market.py'a taşındı (A5.9).
