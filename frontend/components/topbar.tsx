...
export function Topbar({ onOpenCommand }: { onOpenCommand: () => void }) {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border bg-card/30 px-6 backdrop-blur-xl">
      ...
      <button
        ...
        className={cn(
          "hidden sm:flex items-center gap-2 rounded-md border border-border bg-background/40",
          "px-3 py-1.5 text-xs text-muted-foreground hover:text-foreground hover:border-ring",
      ...
      <Button variant="ghost" size="icon" className="relative" aria-label="Bildirimler">
        ...
        <span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-destructive shadow-[0_0_8px_currentColor] animate-pulse" />
      </Button>
